...
from .apis import PostListAPIView, PostDetailAPIView, UserPostListAPIView, UserLikeAPIView, SearchAPIView

app_name = 'api_post'

urlpatterns = [
    path('list', PostListAPIView.as_view(), name='api_post_list'),
    path('<int:id>', PostDetailAPIView.as_view(), name='api_specific_post'),
